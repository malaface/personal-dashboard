...
export const navigation: NavigationItem[] = [
  ...
  { name: "Nutrición", href: "/dashboard/nutrition", icon: CalendarIcon, showInBottomNav: false },
  { name: "Familia", href: "/dashboard/family", icon: UserGroupIcon, showInBottomNav: true },
  { name: "Analítica", href: "/dashboard/analytics", icon: ChartPieIcon, showInBottomNav: false },
]
